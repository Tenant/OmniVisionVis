...
int CoordinateConvertion::WGS84_Local(double *WGS84) {
	double a1 = 6378137.0;
	double b1 = 6356752.3; // For WGS84 (m)
	double a2 = 6377397.155;
	double b2 = 6356078.963; // For 日本測地座標系
...
int CoordinateConvertion::Local_WGS84(double *Tokyo) {
	double a1 = 6377397.155;
	double b1 = 6356078.963; // For 日本測地座標系
	double a2 = 6378137.0;
	double b2 = 6356752.3; // For WGS84 (m)
...
void CoordinateConvertion::SetCoordinateParameters(COORDINATESYSTEMS coordsys, double lat, double lon) {
    ...
    case _BEJING54:
        ...
        DEF_L0 = 116.0;
        break;
    case _BEIJINGLOCAL://一开始的离这次实验的坐标太远了
        DEF_A2 = 6377397.155;
        DEF_B2 = 6356078.963;
        DEF_B0 = 40.0;
		DEF_L0 = 116.0;
